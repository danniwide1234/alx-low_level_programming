 ...
 * @e_ident: An array containing the
 * ELF magic numbers being pointed to
 *
 * Description: exit code 98 activiated If the file is not an ELF file
 */
void check_elf(unsigned char *e_ident)
{
	int count;
 ...
 * @e_ident: An array containing the ELF magic numbers being pointed to.
 *
 ...
 * @e_ident: An array containing the ELF class being pointed to.
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
 ...
 * @e_ident: an array containing the ELF version being pointed to
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
 ...
 * @e_ident: an array containing the ELF ABI version being pointed to
 */
void print_abi(unsigned char *e_ident)
{
